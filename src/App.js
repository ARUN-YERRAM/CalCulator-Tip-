/**
 * The above function is a React component that calculates the split total of a bill based on the bill
 * amount, tip percentage, and number of people splitting the bill.
 * @returns The App component is being returned, which contains the JSX elements for the application's
 * user interface.
 */
